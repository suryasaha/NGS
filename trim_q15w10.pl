#!/usr/bin/env perl
# Source: https://github.com/ngscomparison/NGS-Benchtop-Comparison/blob/master/scripts/trimming/trim_q15w10.pl
# Trims Ion torrent reads with a sliding window of quality cutoff score
